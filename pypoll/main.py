...
with open("Election_Results.txt","w+") as output:
    ...
    print("-----------------------------------------", file=output)
    print(f"{first}: {firstpercent}.00% ({firstvotes})", file=output)
    print(f"{second}: {secondpercent}.00% ({secondvotes})", file=output)
    print(f"{third}: {thirdpercent}.00% ({thirdvotes})", file=output)
    print(f"{fourth}: {fourthpercent}.00% ({fourthvotes})", file=output)
    print("-----------------------------------------", file=output)
    print("Winner: Khan", file=output)
    print("-----------------------------------------", file=output)
